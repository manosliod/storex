...
import { editStoreUser } from '../../../../store/apps/currentStoreUser'
...
const StoreUserViewOverview = ({ userData, error, storeId }: Props) => {
  const defaultValues = {
    email: '',
    username: '',
    fullName: '',
  ...
  useEffect(() => {
    ...
    router.push(
      {
        pathname: `/stores/${storeId}/user/${userData.username}`
      },
...
export default StoreUserViewOverview
